...
public class Main {
    public static void main(String[] args) {
        try (Connection conn = ConexionDB.getInstance()) {
            ...
            studentService.update(new StudentDto(1L, "Likun", "liwu0156@cue.edu.co", "I", "Ingeniería"));
            //studentRepository.delete(1L);

            System.out.println(teacherService.list());
            System.out.println(teacherService.byId(1L));
            teacherService.update(new TeacherDto(1L, "Valeria Martinez", "Mmartinez@cue.edu.co"));
